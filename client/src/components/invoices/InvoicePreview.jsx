...
import {
  Dialog,
  DialogContent,
  DialogTitle, // ✅ FIX 1: Ye import missing tha!
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl bg-muted p-0 overflow-hidden">
        ...
        {/* ================= ACTION BAR ================= */}
        <div className="flex justify-end gap-2 p-4 pr-20 border-b bg-card">
        ...
        >
          ...
          <div className="flex justify-between items-start border-b pb-6 mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                {/* ✅ FIX 2: Data ko safe banaya (?) lagakar */}
                <h1 className="text-2xl font-bold">{shopDetails?.name || "Shop Name"}</h1>
                <p className="text-sm text-gray-600">{shopDetails?.address || "Address"}</p>
          ...
          <table className="w-full border border-gray-200 mb-6">
            ...
            <tbody>
              {/* ✅ FIX 2: map function ko safe banaya */}
          ...
          <div className="mt-10 border-t pt-4 text-center text-sm text-gray-500">
            {/* ✅ FIX 2: toUpperCase ko safe banaya */}
            <p>Payment Method: {invoice?.paymentType?.toUpperCase() || "N/A"}</p>
            <p className="mt-1">
